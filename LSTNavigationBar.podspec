...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LSTNavigationBar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/490790096@qq.com/LSTNavigationBar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '490790096@qq.com' => 'LoSenTrad@163.com' }
  s.source           = { :git => 'https://github.com/490790096@qq.com/LSTNavigationBar.git', :tag => s.version.to_s }
